...
public class DefaultHttpClient {
        ...
        private static Logger logger = LoggerFactory.getLogger(DefaultHttpClient.class);    //日志记录
         ...
         * @return
                 */
    public static String httpPost(String url,String date, boolean noNeedResponse){
        //post请求返回结果
        ...
        try {
            if (null != date) {
                //解决中文乱码问题
                StringEntity entity = new StringEntity(date.toString(), "utf-8");
